...
export default function Landing() {
  ...
  return (
    <>
      ...
      <div style={{ position: "absolute", top: "50%", left: "50%", transform: "translate(-50%,100%)", color: "white", fontSize: "5rem", height: "fit-content", filter: `blur(${txt}px)`, marginTop: txt * 12 + "px" }}>Made By W.ever</div>
    </>
  )
