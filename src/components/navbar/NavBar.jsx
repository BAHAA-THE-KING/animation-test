  ...
  return(
    ...
    <div className="container" style={{zIndex: "10"}}>
      <div className="navbar d-flex justify-content-between align-items-center" style={{zIndex: "10", position: "fixed", width: "83%"}}>
        <div className="d-flex justify-content-center align-items-center" style={{width:"140px", height:"100px"}}><img className="img-fluid" src={'assets/logo small.png'} alt="" /></div>
